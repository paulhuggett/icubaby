...
std::vector<char16_t> convert_8_to_16 (std::vector<char8_t> const& in) {
  ...
  dump_vector (out16);
  assert ((out16 == std::vector{{char16_t{0x3053}, char16_t{0x3093}, char16_t{0x306B}, char16_t{0x3061},
...
std::vector<char32_t> convert_8_to_32 (std::vector<char8_t> const& in) {
  ...
  dump_vector (out32);
  assert ((out32 == std::vector{{char32_t{0x3053}, char32_t{0x3093}, char32_t{0x306B}, char32_t{0x3061},
...
std::vector<char16_t> convert_32_to_16 (std::vector<char32_t> const& out32) {
  ...
  std::ranges::copy (out32 | icubaby::ranges::transcode<char32_t, char16_t>, std::back_inserter (out16));
  dump_vector (out16);
  assert ((out16 == std::vector{{char16_t{0x3053}, char16_t{0x3093}, char16_t{0x306B}, char16_t{0x3061},
                                 char16_t{0x306F}, char16_t{0x4E16}, char16_t{0x754C}, char16_t{0x000A}}}));
  return out16;
...
std::vector<char32_t> convert_16_to_32 (std::vector<char16_t> const& out16) {
  ...
  std::ranges::copy (out16 | icubaby::ranges::transcode<char16_t, char32_t>, std::back_inserter (out32));
  dump_vector (out32);
  assert ((out32 == std::vector{{char32_t{0x3053}, char32_t{0x3093}, char32_t{0x306B}, char32_t{0x3061},
                                 char32_t{0x306F}, char32_t{0x4E16}, char32_t{0x754C}, char32_t{0x000A}}}));
  return out32;
...
std::vector<char8_t> convert_16_to_8 (std::vector<char16_t> const& out16) {
  ...
  std::ranges::copy (out16 | icubaby::ranges::transcode<char16_t, char8_t>, std::back_inserter (out8));
  dump_vector (out8);
  return out8;
}
